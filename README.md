...
python python/train_baseline.py \
  ...
  --skip-check-env
```
<img width="100" height="260" alt="Screen Recording 2026-05-04 at 3 39 41 PM" src="https://github.com/user-attachments/assets/324c0544-d3c8-4299-aaae-0dd8f29dfb64" />
